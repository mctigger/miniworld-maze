...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='/home/jypark/datasets/memory-maze-3x7-reset-new-test-longer-generation')
    ...
    while episode_idx < args.episode_start + args.num_episodes:
        ...
        switch_room_steps = [
            ...
            np.random.randint(480, 501),
            np.random.randint(580, 601),
            np.random.randint(680, 701),
            np.random.randint(780, 801),
            np.random.randint(880, 901),
        ]
