...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='/home/jypark/datasets/memory-maze-7x19-reset-two-traversals-new')
    ...
    while episode_idx < args.episode_start + args.num_episodes:
        ...
        switch_room_steps = [np.random.randint(i * 100 + 80, i * 100 + 101) for i in range(19)]
        switch_room_steps[10] = 1100
