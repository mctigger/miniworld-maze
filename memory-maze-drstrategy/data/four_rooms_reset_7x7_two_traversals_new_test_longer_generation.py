...
def main():
    ...
    parser.add_argument('--episode_start', type=int, default=30000)
    parser.add_argument('--num_episodes', type=int, default=500)
    parser.add_argument('--episode_len', type=int, default=2000)
    parser.add_argument('--save_dir', type=str, default='/home/jypark/datasets/memory-maze-7x7-reset-two-traversals-new-test-longer-generation')
    ...
    while episode_idx < args.episode_start + args.num_episodes:
        ...
        switch_room_steps = [
            ...
            np.random.randint(975, 1001),
            np.random.randint(1100, 1126),
            np.random.randint(1225, 1251),
            np.random.randint(1350, 1376),
            np.random.randint(1475, 1501),
            np.random.randint(1600, 1626),
            np.random.randint(1725, 1751),
            np.random.randint(1850, 1876),
        ]
