...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='/home/jypark/datasets/memory-maze-7x7-reset-copy-new-500')
    ...
    while episode_idx < args.episode_start + args.num_episodes:
        ...
        switch_room_steps = [
            np.random.randint( 65,  76),
            np.random.randint(140, 151),
            np.random.randint(215, 226),
            299,
        ]
        copy_step = np.random.randint(30, 100)
