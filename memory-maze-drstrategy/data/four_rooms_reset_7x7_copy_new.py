...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='/home/jypark/datasets/memory-maze-7x7-reset-copy-new')
    ...
    while episode_idx < args.episode_start + args.num_episodes:
        ...
        switch_room_step_1 = np.random.randint(150, 201)
        switch_room_step_2 = np.random.randint(350, 401)
        switch_room_step_3 = np.random.randint(550, 601)
        switch_room_step_4 = 799
        copy_step = np.random.randint(600)
