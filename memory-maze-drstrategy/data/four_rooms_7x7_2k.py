...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='/common/home/fd213/datasets/memory-maze-7x7-2k')
    ...
    while episode_idx < args.episode_start + args.num_episodes:
        ...
        try:
            ...
            switch_room_step_1 = np.random.randint(350, 401)
            switch_room_step_2 = np.random.randint(750, 801)
            switch_room_step_3 = np.random.randint(1150, 1201)
            switch_room_step_4 = np.random.randint(1550, 1601)
