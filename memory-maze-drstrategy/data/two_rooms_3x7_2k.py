...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='/common/home/fd213/datasets/memory-maze-3x7-2k')
    ...
    env = tasks.memory_maze_two_rooms_3x7(global_observables=True, top_camera=args.top_camera, **kwargs)
    num_actions = 6
