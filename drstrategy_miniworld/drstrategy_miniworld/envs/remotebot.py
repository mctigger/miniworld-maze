...
class RemoteBot(gym.Env, utils.EzPickle):
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        utils.EzPickle.__init__(self, serverAddr=serverAddr, serverPort=serverPort, 
                               obs_width=obs_width, obs_height=obs_height, **kwargs)
    ...
    def step(self, action):
        ...
        return self.img, reward, terminated, truncated, {}
