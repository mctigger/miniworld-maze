...
class EntityCollection:
    ...
    def _get_spatial_candidates(self, position: np.ndarray, radius: float) -> List[Entity]:
...
class EntityManager:
    ...
    def add_entity(self, entity: Entity, position: Optional[np.ndarray] = None, 
                   **kwargs) -> None:
    ...
    def remove_entity(self, entity: Entity) -> bool:
        ...
        removed = (self.static_entities.remove(entity) or 
    ...
    def get_entities_in_radius(self, position: np.ndarray, radius: float, 
                              include_static: bool = True, 
                              include_dynamic: bool = True) -> List[Entity]:
    ...
    def get_visible_entities(self, camera_frustum: dict) -> List[Entity]:
        ...
        min_pos = np.array([camera_frustum.get('min_x', -100), 
                           camera_frustum.get('min_y', -100),
                           camera_frustum.get('min_z', -100)])
        max_pos = np.array([camera_frustum.get('max_x', 100), 
